...
var NewsFeedView = function (_super) {
  ...
  NewsFeedView.prototype.render = function () {
    // defaultpage일 경우 substr에 아무것도 없음
    ...
    this.setTemplateData('next_page', String(window.store.currentPage < 3 ? window.store.currentPage + 1 : 3));
    this.updateView();
  };
...
/*
  ...
  복잡도가 높은 코드는 지양하자
*/
},{"./core/router":"src/core/router.ts","./page":"src/page/index.ts"}],"../../Users/vitbo/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../Users/vitbo/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
